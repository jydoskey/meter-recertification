          ...
          <div class="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6">
              ...
              <div class="flex flex-col gap-6">
                <div class="inline-flex items-center" v-for="time in timetype" :name="time.id">
                  <label class="relative flex items-center p-1 rounded-full cursor-pointer">
                    <input name="1kwh" id="kwhdrop" type="radio" :id="time.id" @click="chooseTimeDrop()" required
                  ...
                  <label class="mt-px font-light text-gray-700 cursor-pointer">
...
export default {
  data() {
    return {
      ...
      voltage: 415,
      timetype: [
        { timename: "Determine the time it will take to drop 1kwh", id: "kwhdrop" },
        { timename: "Determine the time it will take to drop 10wh", id: "whdrop" }
      ]
    }
  },
  ...
  methods: {
    ...
    kwhTimeDrop() {
      let oneKwhTime = 1000 / (this.voltage * this.avgCurrentCalc() * Math.sqrt(3))
    ...
    whTimeDrop() {
      let tenWhTime = 10 / (this.voltage * this.avgCurrentCalc() * Math.sqrt(3))
